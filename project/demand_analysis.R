...
write.csv(plan.day,'weekdaydemand.csv',row.names = FALSE)
write.csv(plan.end,'weekenddemand.csv',row.names = FALSE)
write.csv(error.day,'weeklyerror.csv',row.names = FALSE)
write.csv(error.end,'weekenderror.csv',row.names = FALSE)
write.csv(anova.d,'anova.csv',row.names = FALSE)
